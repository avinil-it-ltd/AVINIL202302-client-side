                ...
                <div class="modal-box relative">
                    ...
                    <form action="" className='mx-2  '>
                        ...
                        <div className='flex justify-between'>
                            ...
                            <input type="text" id="physics" placeholder='Enter Physics number' name="physics" class="w-full mx-2 my-2  rounded border border-gray-300 focus:border-indigo-500 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                        </div>

                        <div className='flex justify-between'>
                            <input type="text" id="chemistry" placeholder='Enter Chemistry number' name="chemistry" class="w-full mx-2 my-2   rounded border border-gray-300 focus:border-indigo-500 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                            <input type="text" id="biology" placeholder='Enter Biology number' name="biology" class="w-full mx-2 my-2  rounded border border-gray-300 focus:border-indigo-500 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                        </div>
