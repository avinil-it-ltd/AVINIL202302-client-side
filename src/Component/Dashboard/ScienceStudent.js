    ...
    return (
        <div>
                ...
                <div class="modal-box relative">
                    ...
                    <form action="" className='mx-2  '>
                        ...
                        <div className='flex justify-between'>
                            ...
                            <input type="text" id="email" placeholder='Enter Physics number' name="email" class="w-full mx-2 my-2  rounded border border-gray-300 focus:border-indigo-500 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                        </div>

                        <div className='flex justify-between'>
                            <input type="text" id="full-name" placeholder='Enter Chemistry number' name="full-name" class="w-full mx-2 my-2   rounded border border-gray-300 focus:border-indigo-500 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                            <input type="text" id="email" placeholder='Enter Biology number' name="email" class="w-full mx-2 my-2  rounded border border-gray-300 focus:border-indigo-500 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                        </div>
            ...
            <div class="modal">
                <div class="modal-box relative">
                    ...
                    <form action="" className='mx-2  '>
                        ...
                        <div className='flex justify-between'>
                            <input type="text" id="full-name" placeholder='Enter Chemistry number' name="full-name" class="w-full mx-2 my-2   rounded border border-gray-300 focus:border-indigo-500 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                            <input type="text" id="email" placeholder='Enter Bio number' name="email" class="w-full mx-2 my-2  rounded border border-gray-300 focus:border-indigo-500 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                        </div>
            ...
            <div class="overflow-x-auto w-full">
                <p className='text-white text-3xl text-center py-2'>All Science Student Here</p>
