                ...
                <div class="modal-box relative  ">
                    ...
                    <form action="" className='mx-2  '>
                        ...
                        <div className='flex justify-between'>
                            ...
                            <input type="text" id="email" placeholder='Enter Accounting number' name="email" class="w-full mx-2 my-2  rounded border border-gray-300 focus:border-indigo-500 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                        </div>

                        <div className='flex justify-between'>
                            <input type="text" id="full-name" placeholder='Enter Finance number' name="full-name" class="w-full mx-2 my-2   rounded border border-gray-300 focus:border-indigo-500 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
